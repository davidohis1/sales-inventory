...
(function () {
    ...
    const THEME_FIELDS = {
        ...
        verdant: [
            { key: 'topbar_text', label: 'Top Announcement Bar Text' },
            { key: 'eyebrow', label: 'Hero Eyebrow Label' },
            { key: 'hero_heading', label: 'Hero Heading', aiKind: 'hero_heading' },
            { key: 'hero_subheading', label: 'Hero Subheading', aiKind: 'hero_subheading' },
        ...
        amara: [
            { key: 'topbar1', label: 'Top Bar — First Item' },
            { key: 'announcement', label: 'Top Bar — Middle Item', aiKind: 'announcement' },
            { key: 'topbar3', label: 'Top Bar — Third Item' },
            { key: 'eyebrow', label: 'Hero Eyebrow Label' },
