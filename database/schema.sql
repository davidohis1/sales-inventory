...
CREATE TABLE IF NOT EXISTS products (
    ...
    specifications TEXT NULL COMMENT 'JSON array of {label,value} pairs — optional, mainly for gadgets/electronics',
    variants TEXT NULL COMMENT 'JSON array of {name,values[]} attribute groups — optional, mainly for fashion/apparel',
